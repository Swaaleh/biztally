...
export default async function DashboardPage() {
  ...
  <h1 className="mb-6 text-4xl font-bold text-primary dark:text-white">Dashboard Overview</h1>
  <p className="mt-2 text-lg mb-4 text-secondary dark:text-gray-300">
